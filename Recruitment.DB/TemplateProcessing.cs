...
namespace CAESDO.Recruitment
{
    ...
    public class TemplateProcessing
    {
        ...
        private string template = "Dear {ApplicantName}<i></i>,<br> <br> Your application for the {PositionTitle} faculty position with the "
                                 + " <span>Department of Any Sciences</span> at the University of California, Davis has not been completed. While the position is open until filled, review of completed "
                                 + " applications will begin on {Deadline}. To ensure your application is considered, please complete your application prior to this date. "
                                 + " <br>  <br> If you feel you have received this message in error, or have questions regarding your application status, please contact us at "
                                 + " <a href=\"mailto:recruitments@ucdavis.edu\">recruitments@ucdavis.edu</a>.";
