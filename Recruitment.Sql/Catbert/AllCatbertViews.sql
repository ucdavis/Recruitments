USE [Recruitment]
GO
/****** Object:  View [dbo].[vUserUnit3]    Script Date: 01/31/2011 10:55:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vUserUnit3]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW [dbo].[vUserUnit3]
AS
SELECT     Catbert3.dbo.Unit.UnitID, Catbert3.dbo.UnitAssociations.UserID, Catbert3.dbo.Unit.FIS_Code
FROM         Catbert3.dbo.UnitAssociations INNER JOIN
                      Catbert3.dbo.Unit ON Catbert3.dbo.UnitAssociations.UnitID = Catbert3.dbo.Unit.UnitID
WHERE     (Catbert3.dbo.UnitAssociations.ApplicationID IN
                          (SELECT     ApplicationID
                            FROM          Catbert3.dbo.Applications
                            WHERE      (Name = ''Recruitment''))) AND (Catbert3.dbo.UnitAssociations.Inactive = 0)
'
GO
IF NOT EXISTS (SELECT * FROM ::fn_listextendedproperty(N'MS_DiagramPane1' , N'SCHEMA',N'dbo', N'VIEW',N'vUserUnit3', NULL,NULL))
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vUserUnit3'
GO
IF NOT EXISTS (SELECT * FROM ::fn_listextendedproperty(N'MS_DiagramPaneCount' , N'SCHEMA',N'dbo', N'VIEW',N'vUserUnit3', NULL,NULL))
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vUserUnit3'
GO
/****** Object:  View [dbo].[vUserUnit]    Script Date: 01/31/2011 10:55:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vUsers3]    Script Date: 01/31/2011 10:55:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vUsers3]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW [dbo].[vUsers3]
AS
...
'
GO
/****** Object:  View [dbo].[vUsers]    Script Date: 01/31/2011 10:55:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vUnits3]    Script Date: 01/31/2011 10:55:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vUnits3]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW [dbo].[vUnits3]
AS
SELECT     UnitID AS id, FullName, ShortName, PPS_Code, FIS_Code, SchoolCode
FROM         Catbert3.dbo.Unit'
GO
/****** Object:  View [dbo].[vUnit]    Script Date: 01/31/2011 10:55:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vLogin3]    Script Date: 01/31/2011 10:55:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vLogin3]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW [dbo].[vLogin3]
AS
...
'
GO
IF NOT EXISTS (SELECT * FROM ::fn_listextendedproperty(N'MS_DiagramPane1' , N'SCHEMA',N'dbo', N'VIEW',N'vLogin3', NULL,NULL))
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane1', @value=N'[0E232FF0-B466-11cf-A24F-00AA00A3EFFF, 1.00]
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vLogin3'
GO
IF NOT EXISTS (SELECT * FROM ::fn_listextendedproperty(N'MS_DiagramPaneCount' , N'SCHEMA',N'dbo', N'VIEW',N'vLogin3', NULL,NULL))
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vLogin3'
GO
/****** Object:  View [dbo].[vLogin]    Script Date: 01/31/2011 10:55:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
