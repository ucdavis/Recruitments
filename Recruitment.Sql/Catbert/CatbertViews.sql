USE [Recruitment]
GO
/****** Object:  View [dbo].[vLogin]    Script Date: 01/31/2011 13:41:10 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vLogin]'))
DROP VIEW [dbo].[vLogin]
GO
/****** Object:  View [dbo].[vUnit]    Script Date: 01/31/2011 13:41:10 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vUnit]'))
DROP VIEW [dbo].[vUnit]
GO
/****** Object:  View [dbo].[vUsers]    Script Date: 01/31/2011 13:41:10 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vUsers]'))
DROP VIEW [dbo].[vUsers]
GO
/****** Object:  View [dbo].[vUserUnit]    Script Date: 01/31/2011 13:41:11 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vUserUnit]'))
