...
namespace CAESDO.Recruitment.Test
{
    ...
    public class UserTest
    {
        ...
        {
            User target = NHibernateHelper.daoFactory.GetUserDao().GetUserByLogin("postit");
            ...
            Assert.AreEqual<string>("Scott", target.FirstName);
            Assert.AreEqual<string>("Kirkland", target.LastName);
        }
