<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="App.aspx.cs" Inherits="CAESDO.Recruitment.Web.App" Title="Position Application" Trace="false" Theme="MainTheme" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
                ...
                <table class="box" style="width:500px;" cellpadding="5">
                    ...
                    <tr>
                        <td colspan="2"><br />
                            ...
                            You will not be able to motify your application after you finalize." meta:resourcekey="litFinalizeResource1"></asp:Literal>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                ...
                <table class="box" style="width:500px; " cellpadding="5">
                    ...
                    <tr>
                        ...
                        <td >
                            ...
                            <asp:RequiredFieldValidator ID="reqValEducationPHDDate" runat="server" ControlToValidate="txtEducationPHDDate" ErrorMessage="* PH.D. Date Required" Display="Dynamic" meta:resourcekey="reqValEducationPHDDateResource1"></asp:RequiredFieldValidator>
                    ...
                    <table cellpadding="5">
                        ...
                        <tr>
                            ...
                            <td  >
                                ...
                                <asp:RequiredFieldValidator id="reqValReferencesAcadTitle" ControlToValidate="txtReferencesAcadTitle" ValidationGroup="References" ErrorMessage="* Academic Title Required" runat="server" meta:resourcekey="reqValReferencesAcadTitleResource1"/>                                
                            </td>
                        </tr>
                        <tr>
                            <td   align="right">
                         ...
                         <tr>
                            ...
                            <td  >
                                ...
                                <asp:RequiredFieldValidator id="reqValReferencesInstitute" ControlToValidate="txtReferencesInstitute" ValidationGroup="References" ErrorMessage="* Institute Required" runat="server" meta:resourcekey="reqValReferencesInstituteResource1"/>
                            </td>
                        </tr>
                        <tr>
                            <td   align="right">
                ...
                <table class="box" style="margin-right:30px;" cellpadding="5">
                    ...
                    <tr>
                        ...
                        <td valign="top"  >
                            ...
                            <br />
                                <asp:RadioButton ID="rbtnAmericanIndian" runat="server" GroupName="Ethnicity" Text="American Indian / Alaskin Native" meta:resourcekey="rbtnAmericanIndianResource1" />
